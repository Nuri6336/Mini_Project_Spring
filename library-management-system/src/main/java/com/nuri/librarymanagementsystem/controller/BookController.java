...
public class BookController {
    ...
    @PutMapping("/update")
    public String updateBook(@RequestParam Integer bookId, @RequestBody BookDto book) throws CustomException {
        bookService.updateBook(bookId, book);
        return "Data has been updated";
    }

    @DeleteMapping("/delete")
    public String deleteBook(@RequestParam Integer bookId) throws CustomException {
